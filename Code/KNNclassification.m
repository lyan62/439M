function class = KNNclassification(k,tFeatures, tLabels, tstFeatures, tstLabels)
% use a method s.t. for KNN, if class does not get majority vote, use NN
% instead...
% input: set # of neighbors
% output: 1*200 double (for 200 test samples in data.mat)
...
[class,accuracy] = KNNEval(k,tFeatures, tLabels, tstFeatures, tstLabels);
