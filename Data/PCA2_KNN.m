function [class,accuracy] = PCA2_KNN(k,num,tFeatures,tstFeatures,tLabels, tstLabels)
...
%      tLabels: 400*1
%      tstLabels: 200*1
features = [tFeatures; tstFeatures]; %[884 * 1920]
...
[class,accuracy] = KNNEval(k,projected_t, tLabels, projected_tst, tstLabels);
end